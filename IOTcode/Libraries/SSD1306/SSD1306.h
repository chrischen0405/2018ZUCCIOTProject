...
/* Exported functions ------------------------------------------------------- */
extern void ssd1306_specify_display_position(uint8_t chXpos, uint8_t chYpos);
...
extern void ssd1306_display_string(uint8_t chXpos, uint8_t chYpos, const uint8_t *pchString, uint8_t chSize);
