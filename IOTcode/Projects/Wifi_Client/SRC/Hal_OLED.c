...
//	RCC_APB2PeriphClockCmd(OLED_SPIx_MISO_CLK | OLED_SPIx_SCK_CLK | OLED_SPIx_MOSI_CLK, ENABLE); 	
	RCC_AHB1PeriphClockCmd(OLED_SPIx_MISO_CLK | OLED_SPIx_SCK_CLK | OLED_SPIx_MOSI_CLK, ENABLE); 	
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource5,GPIO_AF_SPI1); 
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource6,GPIO_AF_SPI1); 
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource7,GPIO_AF_SPI1); 

//RCC_APB2PeriphClockCmd(OLED_SPIx_CLK, ENABLE);//??SPI1 
 
/**************Enables the High Speed APB2 (CS DC RES) peripheral clock********/	
//	RCC_APB2PeriphClockCmd(OLED_CS_CLK | OLED_DC_CLK | OLED_RES_CLK, ENABLE); 
	RCC_AHB1PeriphClockCmd(OLED_CS_CLK | OLED_DC_CLK | OLED_RES_CLK, ENABLE); 
...
{
#define MAX_CHAR_POSX OLED_MAX_COL - 6
